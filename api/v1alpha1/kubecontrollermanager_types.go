...
type KubeControllerManagerTLS struct {
	CA                    string `json:"ca,omitempty"`
	KubeControllerManager string `json:"kube-controller-manager-tls,omitempty"`
	ServiceAccountsTLS    string `json:"service-accounts-tls,omitempty"`
}
...
//+kubebuilder:resource:shortName=kcm
